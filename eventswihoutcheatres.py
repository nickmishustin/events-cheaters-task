...
class EventsWithoutCheaters:
    ...
    def __init__(self, cheaters_path, result_path, server_path, client_path, target_date):
    ...
    def __remove_cheaters(self):
        ...
        self.df = df_cheaters.merge(self.df, left_on='player_id', right_on='player_id')
        ...
        self.df['datetime_diff']  = (self.df['ban_time'] - self.df['server_time']).dt.days 
    ...
    def set_df(self):
        ...
        self.df = df_server.merge(df_client, left_on='error_id', right_on='error_id')
        self.df.rename(
            columns={
